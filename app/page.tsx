  ...
  return (
    <main className="min-h-screen bg-[#FDF6EE]">
      ...
      <section className="max-w-lg mx-auto px-6 pt-12 pb-10 text-center">
        ...
        <Link
          href="/signup"
          className="inline-block w-full sm:w-auto bg-[#E8A838] text-white text-base font-semibold px-8 py-4 rounded-xl hover:bg-[#d4952d] transition-colors"
        >
          Get your first story free tonight
        </Link>
        <p className="text-xs text-[#bbb] mt-3">Takes 2 minutes. No credit card.</p>
      ...
      <section className="max-w-lg mx-auto px-6 pb-10">
        <div className="bg-white rounded-2xl border border-[#e8ddd0] px-7 py-7 shadow-sm">
          ...
          <div className="border-t border-[#f0e8de] pt-5">
            <p className="text-xs text-[#bbb] text-center mb-3">How is Emma feeling tonight?</p>
      ...
      {/* 3 features — compact row */}
      <section className="max-w-lg mx-auto px-6 pb-10">
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="bg-white rounded-xl border border-[#e8ddd0] p-4">
            <p className="text-xs font-bold text-[#E8A838] mb-2">01</p>
            <p className="text-xs font-semibold text-[#2C2A26] leading-snug">Tell us about your kid</p>
          </div>
          <div className="bg-white rounded-xl border border-[#e8ddd0] p-4">
            <p className="text-xs font-bold text-[#E8A838] mb-2">02</p>
            <p className="text-xs font-semibold text-[#2C2A26] leading-snug">Story lands in your inbox</p>
          </div>
          <div className="bg-white rounded-xl border border-[#e8ddd0] p-4">
            <p className="text-xs font-bold text-[#E8A838] mb-2">03</p>
            <p className="text-xs font-semibold text-[#2C2A26] leading-snug">Pick a mood. Next adapts.</p>
          </div>
        </div>
      </section>
